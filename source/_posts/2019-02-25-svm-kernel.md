...
我之前写过一个关于[SVM中核函数的基本原理](https://chaopei.github.io/blog/2018/07/kernel_method.html)，讲述了核函数的本质是利用高维映射来解决线性不可分的情况。但是具体怎么映射，以及核函数为什么写成两个向量内积的形式还存在一些疑问，这篇文章对这些知识点做一些总结。
